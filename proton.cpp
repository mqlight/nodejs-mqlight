...
{
  HandleScope scope;
  Local<Value> args[2] = {Local<Value>::New(String::New(id ? id : NO_CLIENT_ID)),
...
void RegisterModule(Handle<Object> exports)
{
  ...
  Local<Value> logVal = Context::GetCurrent()->Global()->Get(String::New("logger"));
  ...
  Proton::loggerEntry = Persistent<Function>::New(Local<Function>::Cast(entryFnc));
  Proton::loggerExit = Persistent<Function>::New(Local<Function>::Cast(exitFnc));
  Proton::loggerLog = Persistent<Function>::New(Local<Function>::Cast(logFnc));
  Proton::loggerBody = Persistent<Function>::New(Local<Function>::Cast(bodyFnc));
  Proton::loggerFFDC = Persistent<Function>::New(Local<Function>::Cast(ffdcFnc));
  Proton::loggerThrow = Persistent<Function>::New(Local<Function>::Cast(throwFnc));
